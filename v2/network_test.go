			...
			Ethernets: Ethernets{
				"id0": &Ethernet{
					PhysicalDevice: PhysicalDevice{
						Match: &Match{
							MacAddress: NilableStringOf("00:11:22:33:44:55"),
						},
						WakeOnLAN: NilableBoolOf(true),
					},
					Device: Device{
						DHCP4: NilableBoolOf(true),
						Addresses: []*Address{
							...
							{
								Address:   "2001:1::1",
								PrefixLen: NilableUint8Of(64),
							},
						},
						Gateway4: NilableStringOf("192.168.14.1"),
						Gateway6: NilableStringOf("2001:1::2"),
						NameServers: &Nameservers{
							...
							Routes: []*Route{
								{
									...
									Table:  NilableUint64Of(70),
									OnLink: NilableBoolOf(true),
									Metric: NilableUint64Of(3),
								},
							},
				...
				"lom": &Ethernet{
					PhysicalDevice: PhysicalDevice{
						Match: &Match{
							Driver: NilableStringOf("ixgbe"),
						},
						SetName: NilableStringOf("lom1"),
					},
					Device: Device{
						DHCP6: NilableBoolOf(true),
					},
				},
				"switchports": &Ethernet{
					PhysicalDevice: PhysicalDevice{
						Match: &Match{
							Name: NilableStringOf("enp2*"),
						},
					},
					Device: Device{
						MTU: NilableUint64Of(1280),
					},
				},
			},
			Wifis: Wifis{
				"all-wlans": &Wifi{
					AccessPoints: AccessPoints{
						"Joe's home": &AccessPoint{
							Password: NilableStringOf("s3kr1t"),
						},
					},
				},
				"wlp1s0": &Wifi{
